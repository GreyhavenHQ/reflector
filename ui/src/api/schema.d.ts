...
export interface paths {
    ...
    "/v1/zulip/streams": {
        ...
        /**
         * Zulip Get Streams
         * @description Get all Zulip streams. Returns [] if the upstream Zulip API is unreachable
    ...
    "/v1/zulip/streams/{stream_id}/topics": {
        ...
        /**
         * Zulip Get Topics
         * @description Get all topics for a specific Zulip stream. Returns [] on upstream failure
...
export interface components {
    schemas: {
        ...
        GetTranscriptWithJSON: {
            ...
            speaker_count: number;
            /** Participants */
            participants: components["schemas"]["TranscriptParticipantWithEmail"][] | null;
            /**
        ...
        SearchResult: {
            ...
            /**
             * Speaker Count
             * @description Number of distinct speakers in the transcript
             * @default 0
             */
            speaker_count: number;
            /** Change Seq */
        ...
        TranscriptWsStatusData: {
             ...
             * @enum {string}
             */
            value: "idle" | "uploaded" | "recording" | "processing" | "error" | "ended";
        };
        /** TranscriptWsTopic */
        TranscriptWsTopic: {
            /**
...
export interface operations {
    ...
    v1_transcript_get: {
        parameters: {
            query?: {
                transcript_format?: "text" | "text-timestamped" | "webvtt-named" | "json";
            };
            header?: never;
            path: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["GetTranscriptWithText"] | components["schemas"]["GetTranscriptWithTextTimestamped"] | components["schemas"]["GetTranscriptWithWebVTTNamed"] | components["schemas"]["GetTranscriptWithJSON"];
                };
            };
            /** @description Validation Error */
            422: {
    ...
    v1_user_get_websocket_events: {
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["UserWsTranscriptCreated"] | components["schemas"]["UserWsTranscriptDeleted"] | components["schemas"]["UserWsTranscriptRestored"] | components["schemas"]["UserWsTranscriptStatus"] | components["schemas"]["UserWsTranscriptFinalTitle"] | components["schemas"]["UserWsTranscriptDuration"];
                };
            };
        };
    };
